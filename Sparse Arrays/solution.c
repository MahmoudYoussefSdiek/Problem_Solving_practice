...
int* matchingStrings(int strings_count, char** strings, int queries_count, char** queries, int* result_count) {
    // Create a counting array for each query in the strings array
    int* queries_count_arr = calloc(queries_count, sizeof(int));

    // Count the occurrences of each query in the strings array
    ...
    // Set the result count to the number of queries
    *result_count = queries_count;

    return queries_count_arr;
}
